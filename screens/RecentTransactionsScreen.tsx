...
export default function RecentTransactionsScreen() {
  ...
  const { history, isLoading, error, refetch } = useVaultHistory(
    ...
    return (
      ...
      >
        <View className="flex-row items-center gap-3">
          ...
          <View>
            <Text className="font-semibold text-gray-900 dark:text-zinc-100">
              {title}
            </Text>
        ...
        <FlatList
              ...
              <View className="flex-1 items-center justify-center py-20">
                {error ? (
                  <>
                    ...
                    <TouchableOpacity
                      onPress={onRefresh}
                      className="mt-4 bg-yellow-500 rounded-full py-2 px-6"
                    >
                  ...
                  <>
                    <Ionicons
                      ...
                      color="#9ca3af"
                    />
                    <Text className="text-gray-500 dark:text-zinc-400 text-center mt-4">
                      No transactions found
                    </Text>
                    <Text className="text-gray-400 dark:text-zinc-500 text-center text-sm mt-1">
          ...
          ListFooterComponent={
            isLoading && !refreshing ? (
              <ActivityIndicator className="mt-4" color="#FDC700" />
            ) : null
          }
        />
      )}
